...
import (
	...
	alpineunfixed "github.com/vulndb/vuln-list-update/alpine-unfixed"
	"github.com/vulndb/vuln-list-update/amazon"
	arch_linux "github.com/vulndb/vuln-list-update/arch"
	"github.com/vulndb/vuln-list-update/chainguard"
	"github.com/vulndb/vuln-list-update/cwe"
	"github.com/vulndb/vuln-list-update/debian/tracker"
	"github.com/vulndb/vuln-list-update/ghsa"
	"github.com/vulndb/vuln-list-update/glad"
	"github.com/vulndb/vuln-list-update/k8s"
	"github.com/vulndb/vuln-list-update/kevc"
	"github.com/vulndb/vuln-list-update/mariner"
	"github.com/vulndb/vuln-list-update/nvd"
	oracleoval "github.com/vulndb/vuln-list-update/oracle/oval"
	"github.com/vulndb/vuln-list-update/osv"
	"github.com/vulndb/vuln-list-update/photon"
	redhatoval "github.com/vulndb/vuln-list-update/redhat/oval"
	"github.com/vulndb/vuln-list-update/redhat/securitydataapi"
	"github.com/vulndb/vuln-list-update/rocky"
	susecvrf "github.com/vulndb/vuln-list-update/suse/cvrf"
	"github.com/vulndb/vuln-list-update/ubuntu"
	"github.com/vulndb/vuln-list-update/utils"
	"github.com/vulndb/vuln-list-update/wolfi"
	"golang.org/x/oauth2"
